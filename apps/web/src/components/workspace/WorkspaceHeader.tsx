...
import { Terminal, FolderOpen, ChevronDown, Check, Zap, Cpu, Key, Database, SlidersHorizontal, Sparkles } from "lucide-react";
...
export function WorkspaceHeader({
  ...
  return (
    <header className="h-16 border-b border-white/[0.08] px-8 flex items-center justify-between bg-black/80 backdrop-blur-xl z-30">
      ...
      {/* ─── UNIFIED TOP-RIGHT WORKSPACE MENU ─── */}
        ...
        {isActionsMenuOpen && (
          <div className="absolute right-0 mt-2 w-80 rounded-2xl bg-[#18181b] p-2 border border-white/20 shadow-2xl z-50 flex flex-col gap-1 animate-in fade-in duration-150">
            ...
            <button
              ...
              className="w-full text-left p-3 rounded-xl text-xs flex items-center gap-3 text-[#a1a1a6] hover:bg-white/[0.06] hover:text-white transition-all cursor-pointer"
            >
